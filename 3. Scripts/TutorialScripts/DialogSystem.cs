...
public class DialogSystem : MonoBehaviour
{
    ...
    [SerializeField] private GameObject background;               // UI 배경
	[SerializeField] private GameObject[] imageDialogs;           // 대화창 Image UI
	...
	private	Speaker currentSpeaker = Speaker.Default;
	...
	private void SetNextDialog()
	{
        ...
        if (currentSpeaker != Speaker.Default)
        {
        ...
        textNames[(int)currentSpeaker].text = dialogs[currentIndex].speakerName;
