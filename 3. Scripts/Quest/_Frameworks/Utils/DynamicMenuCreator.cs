...
public class DynamicMenuCreator : MonoBehaviour
{
    ...
    static void CreateScriptableObject<T>(T data, System.Type type, int index) where T : new()
    {
        ...
        if (type.Name == "QuestSO")
        {
            directoryPath = $"Assets/Resources/Data/Quest/{type.Name}";
        }
        else if (type.Name == "MonsterStatSO")
        {
            directoryPath = $"Assets/Resources/Data/Monster/{type.Name}";
        }
        else if (type.Name == "ArchInfoSO")
        {
            directoryPath = $"Assets/Resources/Data/Arch/{type.Name}";
        }

        // string directoryPath = $"Assets/Resources/Data/Quest/{type.Name}";
        // $"Assets/Resources/ScriptableObjects/{type.Name}";
